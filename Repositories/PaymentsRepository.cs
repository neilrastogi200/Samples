...
namespace Sonovate.CodeTest.Repositories
{
    internal class PaymentsRepository : IPaymentsRepository
    {
        public IList<Payment> GetBetweenDates(DateTime start, DateTime end)
        {
            ...
            {
                new Payment { AgencyId = "Agency 1", Balance = 20000.00m, PaymentDate = new DateTime(2020, 03, 10)},
                new Payment { AgencyId = "Agency 2", Balance = 7500.00m, PaymentDate = new DateTime(2020, 03, 16)},
                new Payment { AgencyId = "Agency 3", Balance = 960.25m, PaymentDate = new DateTime(2020, 03, 20)},
